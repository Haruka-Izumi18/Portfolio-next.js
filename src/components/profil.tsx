...
export default function Profil() {
  return (
    <>
      <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 justify-center items-center lg:items-start w-full px-4">
        <div className="w-full max-w-[280px] sm:max-w-[350px] lg:max-w-[450px] shrink-0">
          <Image
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 pt-6 sm:pt-3 gap-4 sm:gap-3 items-stretch w-full px-4">
